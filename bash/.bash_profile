...
alias gst='git stash'
alias gsth='git stash show --patch --format=fuller --date=format-local:"%a %Y-%m-%d %H:%M"'
alias gstl='git stash list --format=medium --stat --date=format-local:"%a %Y-%m-%d %H:%M"'
...
alias gy='git show --format=fuller --date=format-local:"%a %Y-%m-%d %H:%M"'
alias gys='gy --stat'
gcf () {
