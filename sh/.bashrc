...
__git_complete glrG _git_log
__git_complete glrS _git_log
__git_complete glS _git_log
__git_complete gsl _git_shortlog
__git_complete gm _git_merge
__git_complete gmb _git_merge_base
__git_complete gmf _git_merge
__git_complete gms _git_show
__git_complete gms1 _git_show
__git_complete gms2 _git_show
...
__git_complete grbid _git_rebase
...
__git_complete grto _git_restore
__git_complete grts _git_restore
__git_complete grtsp _git_restore
__git_complete grtt _git_restore
...
__git_complete gsty _git_stash
__git_complete gt _git_tag
__git_complete gtd _git_tag
__git_complete gtp _git_tag
__git_complete gtm _git_tag
__git_complete gtn _git_tag
...
brew () {
    if [ "$*" == "up" ]; then
        command brew update && command brew upgrade --yes && command brew upgrade --cask --yes
    elif [ "$*" == "dump" ]; then
