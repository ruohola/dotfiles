...
alias _gl='git log --branches --remotes --tags --date-order --color=always'
alias gl='_gl --graph'
alias glc='git log --branches --tags --graph --date-order --color=always'
# FIXME: doesn't show the date
alias glf='_gl --format=full --name-status'
alias glp='_gl --format=full --patch'
alias glg='glf --regexp-ignore-case --grep'
alias glG='glp -G'
alias glS='glp -S'
alias glGr='glp --regexp-ignore-case --pickaxe-regex -G'
alias glSr='glp --regexp-ignore-case --pickaxe-regex -S'
