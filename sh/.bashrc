...
alias glp='git log --format=fuller --patch --ext-diff'
alias glb='git log --reverse "$(__git_default_remote_branch)"..'  # Mnemonic: git log branch
alias glbf='glf --reverse "$(__git_default_remote_branch)"..'
alias glbp='glp --reverse "$(__git_default_remote_branch)"..'
...
alias gy='git show --format=fuller --first-parent --ext-diff'
