...
export FZF_IGNORES=Applications,Library,Movies,Music,Pictures,Qt,node_modules,venv,.DS_Store,.Trash,.cache,.git,.mypy_cache,.next,.npm,.pyenv,.pytest_cache,.stack,.temp,__pycache__
